...
# Scenario: changes in CAP_f
parameters = "parameters/base/"
results = "scenario_capacity/CAP_f/results/"
...
for change in percentage_variations:
	...
	results_foldername = f'CAP_f_{int(change * 100)}/'
	...
	if m.Status == GRB.OPTIMAL:
		...
		activation_matrix.to_csv(results_path + f"CAP_f_{int(change * 100)}_activation_matrix.csv")
		...
		k2_lf = qklf_df['k2']
		k3_lf = qklf_df['k3']
		k1_lf.to_csv(results_path + f"CAP_f_{int(change * 100)}_Q_klf_k1.csv")
		k2_lf.to_csv(results_path + f"CAP_f_{int(change * 100)}_Q_klf_k2.csv")
		k3_lf.to_csv(results_path + f"CAP_f_{int(change * 100)}_Q_klf_k3.csv")
		...
		k2_lh = qklh_df['k2']
		k3_lh = qklh_df['k3']
		k1_lh.to_csv(results_path + f"CAP_f_{int(change * 100)}_Q_klh_k1.csv")
		k2_lh.to_csv(results_path + f"CAP_f_{int(change * 100)}_Q_klh_k2.csv")
		k3_lh.to_csv(results_path + f"CAP_f_{int(change * 100)}_Q_klh_k3.csv")
		...
		qfi = qfi.unstack()
		qfi.to_csv(results_path + f"CAP_f_{int(change * 100)}_Q_fi.csv")
		...
		qgi = qgi.unstack()
		qgi.to_csv(results_path + f"CAP_f_{int(change * 100)}_Q_gi.csv")
		...
		qhi = qhi.unstack()
		qhi.to_csv(results_path + f"CAP_f_{int(change * 100)}_Q_hi.csv")
		...
		qhi_bar.to_csv(results_path + f"CAP_f_{int(change * 100)}_Q_hi_bar.csv")
		...
		qju = qju.unstack()
		qju.to_csv(results_path + f"CAP_f_{int(change * 100)}_Q_ju.csv")
		...
		k2_uv = qkuv_df['k2']
		k3_uv = qkuv_df['k3']
		k1_uv.to_csv(results_path + f"CAP_f_{int(change * 100)}_Q_kuv_k1.csv")
		k2_uv.to_csv(results_path + f"CAP_f_{int(change * 100)}_Q_kuv_k2.csv")
		k3_uv.to_csv(results_path + f"CAP_f_{int(change * 100)}_Q_kuv_k3.csv")
		...
		k2_uw = qkuw_df['k2']
		k3_uw = qkuw_df['k3']
		k1_uw.to_csv(results_path + f"CAP_f_{int(change * 100)}_Q_kuw_k1.csv")
		k2_uw.to_csv(results_path + f"CAP_f_{int(change * 100)}_Q_kuw_k2.csv")
		k3_uw.to_csv(results_path + f"CAP_f_{int(change * 100)}_Q_kuw_k3.csv")
		...
		qug = qug.unstack()
		qug.to_csv(results_path + f"CAP_f_{int(change * 100)}_Q_ug.csv")
		...
		quh = quh.unstack()
		quh.to_csv(results_path + f"CAP_f_{int(change * 100)}_Q_uh.csv")
		...
		k2_vf = qkvf_df['k2']
		k3_vf = qkvf_df['k3']
		k1_vf.to_csv(results_path + f"CAP_f_{int(change * 100)}_Q_kvf_k1.csv")
		k2_vf.to_csv(results_path + f"CAP_f_{int(change * 100)}_Q_kvf_k2.csv")
		k3_vf.to_csv(results_path + f"CAP_f_{int(change * 100)}_Q_kvf_k3.csv")
		...
		k2_vh = qkvh_df['k2']
		k3_vh = qkvh_df['k3']
		k1_vh.to_csv(results_path + f"CAP_f_{int(change * 100)}_Q_kvh_k1.csv")
		k2_vh.to_csv(results_path + f"CAP_f_{int(change * 100)}_Q_kvh_k2.csv")
		k3_vh.to_csv(results_path + f"CAP_f_{int(change * 100)}_Q_kvh_k3.csv")
